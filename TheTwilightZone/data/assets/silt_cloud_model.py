...
def create_silt_cloud_sprite(radius: int = 42) -> pygame.Surface:
    ...
    pygame.draw.circle(surface, (218, 222, 225, 22), (cx, cy), max(8, radius - 8))
    pygame.draw.circle(surface, (156, 161, 165, 25), (cx + 12, cy - 10), max(9, radius // 3))
    pygame.draw.circle(surface, (126, 131, 135, 22), (cx - 16, cy + 10), max(11, radius // 3))
